...
*****/
CREATE   VIEW [etl].[vw_Load_DimCustomer_CRM_Contact] AS 
...
--base set
		...
		, NULL AS [AccountType] 
		, NULL AS [AccountRep] 
		, c.parentcustomeridname AS [CompanyName] 
		...
		/*AddressPrimary*/
		    ...
		    ,CASE WHEN c.parentcustomerid IS NOT NULL AND c.parentcustomeridtype = 'account' THEN c.parentcustomerid ELSE NULL END AS[ExtAttribute7] 
...
--			select top 100 *
		...
		--	FROM oilers_reporting.Prodcopy.Contact_old c
