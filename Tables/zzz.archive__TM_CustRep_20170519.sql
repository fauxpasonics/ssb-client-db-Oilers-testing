CREATE TABLE [zzz].[archive__TM_CustRep_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_CustRe__Creat__23F3538A] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_CustRep_20170519] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_CustRep_20170519] ([SourceFileName])
GO
