...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Creat__7A8729A3] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Updat__7B7B4DDC] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimSeason__IsDel__7C6F7215] DEFAULT ((0)),
