...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Inser__093F5D4E] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Updat__0A338187] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[ods__TM_Solicit_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Solic__3213E83F62395BC4] PRIMARY KEY CLUSTERED  ([id])
GO
