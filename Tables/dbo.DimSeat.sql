...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeat__Created__546180BB] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeat__Updated__5555A4F4] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimSeat__IsDelet__5649C92D] DEFAULT ((0)),
[DeleteDate] [datetime] NULL CONSTRAINT [DF__DimSeat__DeleteD__573DED66] DEFAULT ((0)),
...
GO
CREATE NONCLUSTERED INDEX [idx_DimSeat_Area_Manifest] ON [dbo].[DimSeat] ([DimArenaId], [ManifestId]) INCLUDE ([SectionName])
GO
