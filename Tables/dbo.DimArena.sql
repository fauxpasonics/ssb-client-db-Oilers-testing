...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimArena__Create__2F2FFC0C] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimArena__Update__30242045] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimArena__IsDele__3118447E] DEFAULT ((0)),
