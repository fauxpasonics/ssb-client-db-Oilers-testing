CREATE TABLE [zzz].[archive__TM_Cust_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Cust__Created__220B0B18] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Cust_20170519] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Cust_20170519] ([SourceFileName])
GO
