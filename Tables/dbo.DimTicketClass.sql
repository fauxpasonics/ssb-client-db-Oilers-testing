...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimTicket__Creat__75C27486] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimTicket__Updat__76B698BF] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimTicket__IsDel__77AABCF8] DEFAULT ((0)),
