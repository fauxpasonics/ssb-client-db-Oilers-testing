CREATE TABLE [zzz].[archive__TM_HeldSeats_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Creat__29AC2CE0] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_HeldSeats_20170519] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_HeldSeats_20170519] ([SourceFileName])
GO
