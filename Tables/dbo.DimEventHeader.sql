...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimEventH__Creat__6B44E613] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimEventH__Updat__6C390A4C] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimEventH__IsDel__6D2D2E85] DEFAULT ((0)),
