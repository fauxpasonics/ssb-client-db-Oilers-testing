CREATE TABLE [zzz].[archive__TM_PromoCode_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Creat__351DDF8C] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_PromoCode_20170519] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_PromoCode_20170519] ([SourceFileName])
GO
