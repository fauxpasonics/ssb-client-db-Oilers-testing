CREATE TABLE [zzz].[ods__TM_Plans_History_bkp_700Rollout]
(
...
GO
ALTER TABLE [zzz].[ods__TM_Plans_History_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Plans_History] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_PlanKey] ON [zzz].[ods__TM_Plans_History_bkp_700Rollout] ([acct_id], [plan_event_id], [ticket_status], [section_id], [row_id], [seat_num]) INCLUDE ([num_seats], [ssbPriceCode])
GO
CREATE NONCLUSTERED INDEX [IDX_ticket_status] ON [zzz].[ods__TM_Plans_History_bkp_700Rollout] ([ticket_status])
GO
CREATE NONCLUSTERED INDEX [IDX_UpdateDate] ON [zzz].[ods__TM_Plans_History_bkp_700Rollout] ([UpdateDate])
GO
