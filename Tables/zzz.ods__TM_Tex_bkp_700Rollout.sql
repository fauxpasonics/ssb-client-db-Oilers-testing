...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__InsertDa__0D0FEE32] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__UpdateDa__0E04126B] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [IDX__TMTex_Activity] ON [zzz].[ods__TM_Tex_bkp_700Rollout] ([activity])
GO
