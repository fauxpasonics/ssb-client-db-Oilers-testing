...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Insert__61316BF4] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Update__6225902D] DEFAULT (getdate()),
...
GO
ALTER TABLE [zzz].[ods__TM_Plans_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Plans__3213E83F36B84F64] PRIMARY KEY CLUSTERED  ([id])
GO
