...
[EventDate] [datetime] NOT NULL CONSTRAINT [DF__EventLog__EventD__54968AE5] DEFAULT (getdate()),
[ExecutionId] [uniqueidentifier] NOT NULL CONSTRAINT [DF__EventLog__Execut__558AAF1E] DEFAULT (newid()),
