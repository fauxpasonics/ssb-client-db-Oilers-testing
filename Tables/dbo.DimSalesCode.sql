...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSalesC__Creat__4F9CCB9E] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSalesC__Updat__5090EFD7] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimSalesC__IsDel__51851410] DEFAULT ((0)),
