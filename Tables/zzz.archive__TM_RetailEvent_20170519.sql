CREATE TABLE [zzz].[archive__TM_RetailEvent_20170519]
(
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_RetailEvent_20170519] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_RetailEvent_20170519] ([SourceFileName])
GO
