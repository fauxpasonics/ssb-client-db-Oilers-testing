...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_SellLo__Inser__477199F1] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_SellLo__Updat__4865BE2A] DEFAULT (getdate()),
