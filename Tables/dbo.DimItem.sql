...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimItem__Created__3E723F9C] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimItem__Updated__3F6663D5] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimItem__IsDelet__405A880E] DEFAULT ((0)),
