...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Inser__382F5661] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Updat__39237A9A] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[ods__TM_PriceCode_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Price__3213E83F7359875C] PRIMARY KEY CLUSTERED  ([id])
GO
