CREATE TABLE [zzz].[archive__TM_Journal_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Journa__Creat__2B947552] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Journal_20170519] ([SourceFileName])
GO
