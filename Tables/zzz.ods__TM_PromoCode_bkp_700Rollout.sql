...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Inser__3EDC53F0] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Updat__3FD07829] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[ods__TM_PromoCode_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Promo__3213E83FAB153005] PRIMARY KEY CLUSTERED  ([id])
GO
