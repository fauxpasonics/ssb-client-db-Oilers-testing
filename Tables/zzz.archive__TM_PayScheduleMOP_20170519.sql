CREATE TABLE [zzz].[archive__TM_PayScheduleMOP_20170519]
(
...
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_archive__TM_PayScheduleMOP] ON [zzz].[archive__TM_PayScheduleMOP_20170519]
GO
