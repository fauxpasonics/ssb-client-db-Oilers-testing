...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Creat__33F4B129] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Updat__34E8D562] DEFAULT (getdate()),
[IsDeleted] [bit] NULL CONSTRAINT [DF__DimSeason__IsDel__35DCF99B] DEFAULT ((0)),
