CREATE TABLE [zzz].[archive__TM_Note_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Note__Created__2F650636] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Note_20170519] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Note_20170519] ([SourceFileName])
GO
