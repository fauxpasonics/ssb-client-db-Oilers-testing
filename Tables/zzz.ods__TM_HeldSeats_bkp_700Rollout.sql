...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Inser__336AA144] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Updat__345EC57D] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[ods__TM_HeldSeats_bkp_700Rollout] ADD CONSTRAINT [PK__TM_HeldS__3213E83FEB3BB9BD] PRIMARY KEY CLUSTERED  ([id])
GO
