CREATE TABLE [etl].[ConfigTmApiRequests_bkp_20170519]
(
...
GO
ALTER TABLE [etl].[ConfigTmApiRequests_bkp_20170519] ADD CONSTRAINT [PK__ConfigTm__3214EC0732F4C700] PRIMARY KEY CLUSTERED  ([Id])
GO
