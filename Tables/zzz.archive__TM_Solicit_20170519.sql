CREATE TABLE [zzz].[archive__TM_Solicit_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Creat__3AD6B8E2] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Solicit_20170519] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Solicit_20170519] ([SourceFileName])
GO
