CREATE TABLE [zzz].[archive__TM_AvailSeats_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Creat__2022C2A6] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_AvailSeats_20170519] ([SourceFileName])
GO
