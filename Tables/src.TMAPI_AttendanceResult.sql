...
[ETL_CreatedDate] [datetime] NULL CONSTRAINT [DF__TMAPI_Att__ETL_C__7FB5F314] DEFAULT (getdate()),
...
GO
ALTER TABLE [src].[TMAPI_AttendanceResult] ADD CONSTRAINT [PK__TMAPI_At__7EF6BFCDD4C00D56] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
