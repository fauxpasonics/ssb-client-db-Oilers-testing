CREATE TABLE [zzz].[archive__TM_Plans_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Create__314D4EA8] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Plans_20170519] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Plans_20170519] ([SourceFileName])
GO
