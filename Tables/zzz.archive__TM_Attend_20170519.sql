CREATE TABLE [zzz].[archive__TM_Attend_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Attend__Creat__408F9238] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Attend_20170519] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Attend_20170519] ([SourceFileName])
GO
