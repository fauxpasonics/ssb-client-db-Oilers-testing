CREATE TABLE [zzz].[archive__TM_ManifestSeat_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Creat__2D7CBDC4] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_ManifestSeat_20170519] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_ManifestSeat_20170519] ([SourceFileName])
GO
