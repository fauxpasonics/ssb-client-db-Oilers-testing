CREATE TABLE [zzz].[archive__TM_CustTrace_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_CustTr__Creat__5F9E293D] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_CustTrace_20170519] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_CustTrace_20170519] ([SourceFileName])
GO
