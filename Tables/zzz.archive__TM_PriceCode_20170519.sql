CREATE TABLE [zzz].[archive__TM_PriceCode_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Creat__3335971A] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_PriceCode_20170519] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_PriceCode_20170519] ([SourceFileName])
GO
