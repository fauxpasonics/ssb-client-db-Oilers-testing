CREATE TABLE [zzz].[archive__TM_Arena_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Arena__Create__1E3A7A34] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Arena_20170519] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Arena_20170519] ([SourceFileName])
GO
