...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Inser__56B3DD81] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Updat__57A801BA] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [zzz].[ods__TM_ManifestSeat_bkp_700Rollout] ADD CONSTRAINT [PK__TM_Manif__3213E83F5C4D7DE3] PRIMARY KEY CLUSTERED  ([id])
GO
