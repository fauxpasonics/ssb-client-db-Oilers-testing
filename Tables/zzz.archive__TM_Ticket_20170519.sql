CREATE TABLE [zzz].[archive__TM_Ticket_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Ticket__Creat__618671AF] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Ticket_20170519] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Ticket_20170519] ([SourceFileName])
GO
