...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Attend__Inser__74444068] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Attend__Updat__753864A1] DEFAULT (getdate()),
