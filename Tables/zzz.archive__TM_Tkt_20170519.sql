CREATE TABLE [zzz].[archive__TM_Tkt_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__CreatedD__3EA749C6] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Tkt_20170519] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Tkt_20170519] ([SourceFileName])
GO
