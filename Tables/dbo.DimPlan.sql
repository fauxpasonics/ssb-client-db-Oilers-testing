...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimPlan__Created__4336F4B9] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimPlan__Updated__442B18F2] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimPlan__IsDelet__451F3D2B] DEFAULT ((0)),
