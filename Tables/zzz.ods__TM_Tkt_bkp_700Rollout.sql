...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__InsertDa__5D60DB10] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__UpdateDa__5E54FF49] DEFAULT (getdate()),
...
GO
CREATE CLUSTERED INDEX [Idx_TM_Tkt_upd_datetime_event_id] ON [zzz].[ods__TM_Tkt_bkp_700Rollout] ([upd_datetime], [acct_id], [event_id])
GO
