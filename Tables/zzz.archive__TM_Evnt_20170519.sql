CREATE TABLE [zzz].[archive__TM_Evnt_20170519]
(
...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Evnt__Created__27C3E46E] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [zzz].[archive__TM_Evnt_20170519] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [zzz].[archive__TM_Evnt_20170519] ([SourceFileName])
GO
