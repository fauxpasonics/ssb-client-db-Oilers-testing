...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimEvent__Create__38B96646] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimEvent__Update__39AD8A7F] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimEvent__IsDele__3AA1AEB8] DEFAULT ((0)),
[DeleteDate] [datetime] NULL,
[IsClosed] [bit] NOT NULL CONSTRAINT [DF__DimEvent__IsClos__3B95D2F1] DEFAULT ((0)),
