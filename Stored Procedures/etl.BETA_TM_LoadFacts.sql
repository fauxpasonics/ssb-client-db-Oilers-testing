...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [etl].[BETA_TM_LoadFacts]
(
...
BEGIN
	...
	EXEC etl.TM_Stage_FactTicketSales @BatchId = '00000000-0000-0000-0000-000000000000', @Options = '<options><LoadDate>2017-09-20</LoadDate></options>'

	SELECT 'Step 3...', GETDATE() ts

	EXEC etl.BETA_Cust_FactTicketSalesProcessing --@BatchId = @BatchId, @Options = @Options
	...
	EXEC [etl].[SSB_StandardModelLoad] @BatchId = '00000000-0000-0000-0000-000000000000', @Target = 'etl.vw_FactHeldSeats', @Source = 'etl.vw_Load_TM_FactHeldSeats', @BusinessKey = 'ETL__SSID_TM_ods_id', @SourceSystem = 'TM'
	...
	EXEC [etl].[SSB_StandardModelLoad] @BatchId = '00000000-0000-0000-0000-000000000000', @Target = 'etl.vw_FactAvailSeats', @Source = 'etl.vw_Load_TM_FactAvailSeats', @BusinessKey = 'ETL__SSID_TM_ods_id', @SourceSystem = 'TM'
